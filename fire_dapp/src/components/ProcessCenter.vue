<template>
  ...
  <div id="Area_ProcessCenter">
    ...
    <!-- <div class="bottom_area">
      <button type="button" class="btn btn-success" @click="completeRepair">수리 완료</button>
...
export default {
  ...
  computed : mapState(['initCarInfoList','popupView']),
  watch : {
    checkRow : function(target){
      console.log("### target Change :" , target);
      this.carInfo = target;
      console.log("### target carInfo :" , this.carInfo);
    }
  },
  methods: {
