<template>
  ...
  <div>
    <table class="table table-bordered table_repair_list">
      <tbody>
        <tr>
          <th>사고접수번호 </th>
          <td><input type="text" class="form-control" placeholder="사고접수번호" aria-label="accidentNo" aria-describedby="basic-addon1"></td>
        </tr>
        <tr>
          <th>정비센터 </th>
...
.table_repair_list input{
  text-align:  left;
}

.table_repair_list td{
  text-align: left;
  width: 50px;
  padding : 10px;
}
.table_repair_list th{
  text-align: center;
  width: 60px;
  padding : 10px;
}
