  ...
  <div>
    <table class="table table-bordered table_list">
      <tbody>
        <tr>
          <th>사고접수번호</th>
          <td><input v-model="accidentNo" type="text" class="form-control" placeholder="사고접수번호" ></td>
        </tr>
        <tr>
          <th>정비센터 </th>
        ...
        <tr>
          <th>수리 부품 </th>
          <td>
             <input type="text" class="form-control" placeholder="좌측 헤드 램프 라이트, 사이드 가니쉬, A필러, 테일램프">
          </td>
        </tr>
        <tr>
          <th>수리 비용 </th>
