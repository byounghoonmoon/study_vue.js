    ...
    <table class="table table_list">
      ...
      <tbody>
        <tr v-for="a in accidentList" :key="a.no">
          <td>
            <input type="checkbox" v-if="checked(a.paymentYn)" disabled >
...
export default {
  ...
  methods: {
    ...
    checked : function(paymentYn){
      if(paymentYn==="Y") return true
      else  return false
    }
  }
